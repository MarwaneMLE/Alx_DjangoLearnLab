...
def home(request):
    return render(request, 'blog/base.html')  # Or whatever template you use

def posts(request):
    return render(request, 'blog/post_list.html')  # Or whatever template you use
...
# Create view to allow aithentificated users to create post
...
# Update View: to allow post authors to edit their posts
...
# Allows users to delete a comment
